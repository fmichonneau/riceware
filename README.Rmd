...
you obtain a string of numbers that look something like
...
numbers. You can use true random numbers by typing:
...
[random package](http://cran.r-project.org/package=random), from Dirk
Eddelbuettel). These numbers are converted from atmospheric noise and is truly
random. However, if you are really concerned about security, this is not perfect
as the numbers are transfered without any form of encryption on the
network. Rolling a physical dice is a more robust approach. If you rolled your
dice 15 times to generate 3 words, you generate your passphrase like this:
